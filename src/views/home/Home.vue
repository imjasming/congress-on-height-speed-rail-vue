    ...
    <div class="menu trans_500">
      <div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
        ...
        <ul>
          ...
          <li class="menu_item"><router-link to="news">News</router-link></li>
          <li class="menu_item"><router-link to="contact">Contact</router-link></li>
        </ul>
      </div>
          ...
          <div class="row">
            <div class="col">
              <div class="home_content">
                ...
                <div class="home_text">Donec quis metus ac arcu luctus accumsan. Nunc in justo tincidunt, sodales nunc
                  id,
                  finibus nibh. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos
                  himenaeos.
                </div>
            ...
            <div class="col-lg-4 footer_col">
              <div class="footer_about">
                ...
                <div class="footer_about_text">
                  <p>Donec quis metus ac arcu luctus accumsan. Nunc in justo tincidunt, sodales nunc id, finibus nibh.
