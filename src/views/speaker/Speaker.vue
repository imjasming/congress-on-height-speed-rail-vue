<template>
  <div class="super_container">
    ...
    <div class="home">
      ...
      <div class="parallax_background parallax-window" data-parallax="scroll" :style="{ background: 'url(' + require('../../assets/speakers.jpg')+')'}" data-speed="0.8"></div>
    ...
    <div class="cta">
      <div class="parallax_background parallax-window" data-parallax="scroll" :style="{ background: 'url(' + require('../../assets/news.jpg')+')'}" data-speed="0.8"></div>
      <div class="container">
        <div class="row">
          <div class="col">
