<template>
  <div class="super_container">
        ...
        <div class="logo menu_logo">
          <a href="#">
            <div class="logo_container d-flex flex-row align-items-start justify-content-start">
              <div class="logo_image"><div><img src="../../assets/logo.png" alt=""></div></div>
    ...
    <div class="home">
      ...
      <div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="../../assets/speakers.jpg" data-speed="0.8"></div>
                      ...
                      <div class="header_nav_content d-flex flex-row align-items-center justify-content-start">
                        <nav class="main_nav">
                          <ul>
                            ...
                            <li class="active"><a href="/speaker">Speakers</a></li>
      ...
      <div class="container reset_container">
        ...
        <div class="row row-lg-eq-height">
          <div class="col-lg-6 speaker_col reset_col">
            <div class="speaker_image" style="background-image:url(../../assets/speaker_1.jpg)"></div>
          </div>
          <div class="col-lg-6">
        ...
        <div class="row row-lg-eq-height">
          ...
          <div class="col-lg-6 speaker_col reset_col order-lg-2 order-1">
            <div class="speaker_image" style="background-image:url(../../assets/speaker_2.jpg)"></div>
          </div>
        </div>
        ...
        <div class="row row-lg-eq-height">
          <div class="col-lg-6 speaker_col reset_col">
            <div class="speaker_image" style="background-image:url(../../assets/speaker_3.jpg)"></div>
          </div>
          <div class="col-lg-6">
            <div class="speaker_content d-flex flex-column align-items-start justify-content-center">
        ...
        <div class="row row-lg-eq-height">
          ...
          <div class="col-lg-6 speaker_col reset_col order-lg-2 order-1">
            <div class="speaker_image" style="background-image:url(../../assets/speaker_4.jpg)"></div>
          </div>
        </div>
